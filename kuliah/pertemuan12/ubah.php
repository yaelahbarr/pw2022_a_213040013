            ...
            <div class="col-8">
                ...
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="npm" name="npm" required minlength="9" maxlength="9" style="width: 150px;" value="<?= $mhs["npm"]; ?>">
                    </div>

                    <div class="mb-3">
                        <label for="nama" class=""form-label>Nama</label>
                        <input type="text" class="form-control" id="nama" name="nama_mhs" required value="<?= $mhs["nama_mhs"]; ?>">
                    </div>
